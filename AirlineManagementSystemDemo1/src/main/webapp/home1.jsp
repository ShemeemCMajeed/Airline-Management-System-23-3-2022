...
<body>
	<div class="banner">
		...
		<div class="container">
			<form action="flightlist1.jsp" method="post" class="form" id="form"
				...
				<div class="form-control">
					<label for="departing">Departing</label><br> <input
						style="width: 100%" type="date" id="departing" name="departing" /><br>
					<small>Error message</small>
				</div>
				<div class="form-control">
					<label for="returning">Returning</label><br> <input
						style="width: 100%" type="date" id="returning" name="returning"
						disabled="disabled" /><br> <small>Error message</small>
				</div>
				<div class="form-control">
