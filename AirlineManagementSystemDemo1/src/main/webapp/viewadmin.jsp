...
<form action="viewadmin.jsp" onsubmit="confirmation()">
<table border="3">
<tr><th style="width: 250px">Username</th><th style="width: 250px">Password</th><th style="width: 250px">First Name</th><th style="width: 250px">Last Name</th><th style="width: 300px">Email</th><th style="width: 95px"></th></tr>
<tr><td></td><td></td><td></td><td></td><td></td><td><input type="submit" value="Delete" style="background-color: blue;color: white"> </td></tr>
</table>
</form>
