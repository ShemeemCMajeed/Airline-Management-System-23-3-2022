	...
	var message = document.getElementById('message');
	 let f=0;
		...
		if(message.value === '') {
			...
			setErrorFor(message, 'Message contains only alphabets,numbers and dot');
			m=0;
...
<div class="container">
<form action="" class="form"  id="form" name="myForm" onsubmit="return checkInputs()">
<div class="form-control">
		...
		<div class="form-control">
			...
			<textarea style="width: 100%;height: 130px" name="message" id="message" placeholder="Message Us" maxlength="150"></textarea><br>
			<small>Error message</small>
		</div>
